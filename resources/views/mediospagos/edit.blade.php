...
@section('styles')
@section('title')
    Medios de Pago | Editar Medio de Pago
@endsection
@endsection
@section('contenido')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Editar Medio de Pago</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('mediospago.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="tipo" placeholder="Ejem: Efectivo"
                                        id="example-text-input" value="{{ $data->tipo }}">
                                    @if ($errors->has('tipo'))

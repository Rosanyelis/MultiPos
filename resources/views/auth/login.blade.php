            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>MultiPos</b></h4>
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="text" name="email" required="" placeholder="Correo Electrónico">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="form-label ms-1" for="customCheck1">Recuerdame</label>
                                        </div>
                                    </div>
                                </div>

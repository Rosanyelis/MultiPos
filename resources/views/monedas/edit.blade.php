        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Editar Moneda</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('moneda.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="abreviatura" placeholder="Ejem: USD"
                                        id="example-text-input" value="{{ $data->abreviatura }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="descripcion"
                                        placeholder="Ejem: Dólares" id="example-text-input" value="{{ $data->descripcion }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="decimales"
                                        placeholder="Ejem: 2" id="example-text-input" value="{{ $data->decimales }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="simbolo"
                                        placeholder="Ejem: $" id="example-text-input" value="{{ $data->simbolo }}">
                            ...
                            <div class="d-flex flex-row-reverse">
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Actualizar Moneda</button>
                            </div>
                        </form>
